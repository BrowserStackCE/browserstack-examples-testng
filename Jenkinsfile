...
node {
    ...
    steps {
        sh '''
            ...
            export JUNIT_XML_FILE_PATH="/var/lib/jenkins/workspace/browserstack-testng-webinar@2/test/target/surefire-reports/junitreports/TEST-com.browserstack.test.suites.e2e.OrderTest.xml"
