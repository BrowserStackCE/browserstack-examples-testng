...
public class WebDriverFactory {
    ...
    private WebDriver createRemoteWebDriver(Platform platform, String testName) {
        ...
        WebDriver webDriver = null;
        try {
            webDriver = new RemoteWebDriver(new URL(remoteDriverConfig.getHubUrl()), platformCapabilities);
        } catch (MalformedURLException malformedURLException) {
            throw new Error("Unable to create RemoteWebDriver for URL :: " + remoteDriverConfig.getHubUrl(), malformedURLException);
        }
        return webDriver;
    }
